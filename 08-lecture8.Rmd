...
Minimizing the objective function with respect to the weights $\mathbf{\omega}$ with a gradient descent optimization method has proven to give good results in a wide range of applications.
