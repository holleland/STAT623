...
**HERE WE WILL WRITE ABOUT ALL THE NICE THINGS YOU WILL LEARN IN THIS COURSE**
...
```{r, echo = FALSE}
#knitr::include_url("http://www.youtube.com/embed/YghkXuLXr7o?rel=0")
knitr::include_app("http://www.youtube.com/embed/YghkXuLXr7o?rel=0", height = "700px")
```

<iframe width="560" height="315" src="http://www.youtube.com/embed/YghkXuLXr7o" frameborder="0"     allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen data-external="1"></iframe>
